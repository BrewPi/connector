...
class MyTestCase(unittest.TestCase):
    ...
    def test_proxyOverrideDelegateMethod(self):
        ...
        self.assertEqual(p.someFunc(0), 10)         # a=10, offset 0, result is 10
        p.a = 20
        self.assertEqual(p.someFunc(15), 35)        # a=20, offset 15, result is 35
        #self.assertEqual(p.delegateFunc(15), 35)    # direct call - if it's 57, that means the original method is called, and not the proxy
